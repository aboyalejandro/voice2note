...
def export_summary(
    ...
    try:
        ...
        s3_client.upload_file(json_file_path, bucket_name, f'{output_file_path}/{json_file_name}')
        print(f"JSON file uploaded to {bucket_name}/{output_file_path}/{json_file_name}")
...
# Save to PostgreSQL
def save_to_postgresql(query: str, 
                       values: tuple, 
                       host: str, 
                       db: str, 
                       user: str, 
